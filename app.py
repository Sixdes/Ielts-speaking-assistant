############################################################
# refer InternLM_openNotebook/Horowag_7b_Craft/demo_webUI.py
############################################################
...
def combine_history(prompt):
    ...
    meta_instruction = ('You are an experienced IELTS speaking assistant.'
                        '- This is an IELTS Coach, is specialised in the speaking section of the IELTS exam.'
                        '-  It not only provides model answers corresponding to specific score bands but also understands the procedure of the speaking section exam thoroughly.'
                        '-  It offers guidance on the three parts of the speaking section: Introduction and Interview, Long Turn, and Two-way Discussion')
...
def main():
    ...
    greetings = [
        "Let's start our IELTS speaking practice.",
        "Let's start learning spoken English.",
        "I will accompany you to practice oral English together."
        "What is your full name? ",
        "Do you work or do you study？",
        "I'm your IELTS speaking assistant, let's practice together.",
